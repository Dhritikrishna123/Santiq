...
class TestConfigManager:
    ...
    def test_load_valid_config(self, temp_dir: Path):
        ...
        config_data = {
            ...
            "loaders": [
                {"plugin": "csv_loader", "params": {"path": "/test/output.csv"}}
            ],
        }
    ...
    def test_environment_variable_substitution(self, temp_dir: Path):
        ...
        try:
            ...
            assert (
                pipeline_config.loaders[0].params["path"] == "/test/output/result.csv"
            )
...
class TestPipelineConfig:
    ...
    def test_valid_minimal_config(self):
        ...
        config_data = {
            "extractor": {"plugin": "csv_extractor", "params": {"path": "/input.csv"}},
            "loaders": [{"plugin": "csv_loader", "params": {"path": "/output.csv"}}],
        }
