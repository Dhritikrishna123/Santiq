...
"""
        ...
        custom_plugins = [
            p for p in plugins["extractor"] if p["name"] == "my_custom_extractor"
        ]
        ...
        instance = plugin_manager.create_plugin_instance(
            "my_custom_extractor", "extractor", {"source": "test"}
        )
    ...
    def test_plugin_api_version_compatibility(self):
        ...
        plugin_info = {"name": "test_plugin", "api_version": "1.0", "source": "test"}
...
'''
    ...
    def test_plugin_configuration_validation(self, test_plugin_classes):
        ...
        instance = plugin_manager.create_plugin_instance(
            "csv_extractor", "extractor", {"path": "/tmp/test.csv"}
        )
