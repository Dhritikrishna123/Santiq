...
class TestPluginDiscovery:
    ...
    def test_discover_local_plugins(self, temp_dir: Path):
        ...
        local_plugin = next(
            p for p in local_plugins if p["name"] == "test_local_plugin"
        )
...
class TestPluginCompatibility:
    ...
    def test_api_version_validation(
        self, plugin_manager: PluginManager, test_plugin_classes
    ):
