...
class TestBasicProfiler:
    ...
    def test_null_detection(self):
        ...
        data = pd.DataFrame({"col1": [1, 2, None, 4], "col2": [None, "b", "c", "d"]})
        ...
        null_issues = [
            issue for issue in result.issues if issue["type"] == "null_values"
        ]
    ...
    def test_duplicate_detection(self):
        ...
        dup_issues = [
            issue for issue in result.issues if issue["type"] == "duplicate_rows"
        ]
    ...
    def test_type_mismatch_detection(self):
        ...
        type_issues = [
            issue for issue in result.issues if issue["type"] == "type_mismatch"
        ]
