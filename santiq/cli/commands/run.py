...
def pipeline(
    ...
    mode: str = typer.Option("manual", help="Execution mode: manual, half-auto, controlled-auto"),
    ...
    if mode not in ["manual", "half-auto", "controlled-auto"]:
        console.print("[red]Error:[/red] Mode must be one of: manual, half-auto, controlled-auto")
        raise typer.Exit(1)
